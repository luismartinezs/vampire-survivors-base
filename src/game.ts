...
class Enemy extends GameObject {
    ...
    constructor(x: number, y: number) {
        super(x, y, 20, 'green'); // Enemy color
        this.speed = 1.5; // Balanced speed for challenge
        this.health = 3; // Requires multiple hits
    }
    ...
    update() {
        ...
        // Move towards player with increased speed based on player level
